    ...
    return (
        <div style={{ width: '332px', margin: '0 100px 40px 0', display: 'inline-block' }}>
            <Card style={{ width: '332px', margin: '0', height: '100%', borderRadius: '20px', background: '#EAF6F5', display: 'inline-block' }}>
                ...
                <Card.Body>
                    <Card.Title style={{ textAlign: 'center' }}>{props.nama}</Card.Title>
                    <Card.Text style={{ textAlign: 'center', fontSize: '14px', overflow: 'auto' }}>{props.deskripsi}</Card.Text>
                    <Card.Title style={{ textAlign: 'center', fontSize: '24px', fontWeight: 'bold' }}>Rp. {props.harga}</Card.Title>
                    ...
                    <Button style={{ borderRadius: '20px', backgroundColor: '#B12929' }}><AiOutlineDelete /></Button>
                </Card.Body>
            </Card>
